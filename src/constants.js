...
import langgraphLogo from './assets/tech_logo/langgraphLogo.png';
import ragLogo from './assets/tech_logo/ragLogo.png';
...
export const SkillsInfo = [
  ...
  export const projects = [
    ...
    {
      id: 4,
      title: "AI-Powered Conversational Interview Assistant",
      description:
        "Developed a real-time AI interview simulator that conducts adaptive technical interviews using LLM agents. Integrated AssemblyAI for speech-to-text and Murf AI for streaming text-to-speech. Implemented memory-aware conversational flow with LangGraph thread-based state management, dynamic follow-up questions based on candidate responses, and structured JSON performance feedback with scoring and improvement suggestions.",
      tags: ["Flask", "LangChain", "LangGraph", "AssemblyAI", "Murf AI", "LLM Agents"],
      github: "https://github.com/AbhiramYad",
      webapp: "#",
    },
    {
      ...
      description:
        "Built a full-stack AI platform that generates complete web applications from natural language prompts. Implemented secure authentication with JWT and bcrypt, project management features to create, view, rename, and delete applications, and Google Gemini integration to generate HTML, CSS, and JavaScript with real-time iframe preview. Designed a chat-based interface with in-browser code editing and download functionality.",
      tags: ["React.js", "Node.js", "Express.js", "MongoDB", "Gemini AI", "JWT"],
      github: "https://github.com/AbhiramYad",
      webapp: "#",
    },
    {
      id: 6,
      title: "Agentic College Chatbot",
      description:
        "Ongoing full-stack AI project to help students access college information like admissions, courses, and placements. Implementing an Agentic RAG chatbot over a knowledge base using Google Gemini, secure JWT authentication, an AI voice counselor for real-time conversations, and RESTful APIs with a responsive React frontend.",
      tags: ["React.js", "Node.js", "MongoDB", "RAG", "Google Gemini", "AI Voice Agents", "JWT"],
      github: "https://github.com/AbhiramYad",
      webapp: "#",
    },
  ];
